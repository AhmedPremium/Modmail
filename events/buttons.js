        ...
        switch (interaction.customId) {
            case 'Close': {
                ...
                await interaction.reply({
                    content: 'Please wait while I close this ticket...',
                    ephemeral: true
                });
                ...
                await user.send({
                    embeds: [
                        new EmbedBuilder()
                            .setTitle('> <:support:1199348027907911830> Your Ticket has been closed.')
                            .setDescription(`**${interaction.user.displayName}** Has closed your ticket. You have now been disconnected from this support ticket. If you need further assistance, please feel free to contact us again. Have a great day!`)
                            .setFooter({
                                text: `${interaction.guild.name} Support Team`
                            })
                            .setColor('Red')
                    ]
                }).catch(null);
                ...
                await user.send({
                    content: 'Ticket messages history:',
                    files: [
                ...
                await webhookClient.send({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setFooter({ text: interaction.guild.name + '\'s Safety Logging system' })
                            .setColor('Red')
                    ]
                });
                ...
                await webhookClient.send({
                    embeds: [
                        new EmbedBuilder()
                        .setTitle('Ticket messages history:')
                    ],
                    files: [
                        new AttachmentBuilder(
                            Buffer.from(transcriptMessages.join('\n'), 'utf-8'), { name: 'history.txt' }
